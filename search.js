...
function filterMenu(pattern){
    ...
    for (let element of menu){
        if(element.name.match(pattern)||element.description.match(pattern)|| element.tag.match(pattern)){
        recherche.push(element)
        }
    }
    const rechercheDiv = document.querySelector('')
