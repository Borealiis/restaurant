    ...
    switch (now.getDay()) {
        case 0:
            if (openClose() && ((hours === 11 && minutes >= 30) || (hours >= 12 && hours < 14))) {
                lines[6].style.borderLeft = '5px solid rgba(82, 199, 82, 0.7)'
                time[6].children[0].style.fontWeight = 'bold'
            } else {
                lines[6].style.borderLeft = '5px solid rgba(255, 0, 0, 0.7)'
            }
            break
        case 1:
            lines[0].style.borderLeft = '5px solid rgba(255, 0, 0, 0.7)'
            break
        case 2:
            if (openClose() && ((hours === 11 && minutes >= 30) || (hours >= 12 && hours < 14))) {
                lines[1].style.borderLeft = '5px solid rgba(82, 199, 82, 0.7)'
                ...
                lines[1].style.borderLeft = '5px solid rgba(255, 0, 0, 0.7)'
            }
            break
        case 3:
            if (openClose() && ((hours === 11 && minutes >= 30) || (hours >= 12 && hours < 14))) {
                lines[2].style.borderLeft = '5px solid rgba(82, 199, 82, 0.7)'
                ...
                lines[2].style.borderLeft = '5px solid rgba(255, 0, 0, 0.7)'
            }
            break
        case 4:
            if (openClose() && ((hours === 11 && minutes >= 30) || (hours >= 12 && hours < 14))) {
                lines[3].style.borderLeft = '5px solid rgba(82, 199, 82, 0.7)'
                time[3].children[0].style.fontWeight = 'bold'
            } else if ((hours >= 18 && hours < 22) || (hours === 22 && minutes < 30)) {
                lines[3].style.borderLeft = '5px solid rgba(82, 199, 82, 0.7)'
                time[3].children[1].style.fontWeight = 'bold'
            } else {
                lines[3].style.borderLeft = '5px solid rgba(255, 0, 0, 0.7)'
            }
            break
        case 5:
            if (openClose() && ((hours === 11 && minutes >= 30) || (hours >= 12 && hours < 14))) {
                lines[4].style.borderLeft = '5px solid rgba(82, 199, 82, 0.7)'
                time[4].children[0].style.fontWeight = 'bold'
            } else if ((hours >= 18 && hours < 22) || (hours === 22 && minutes < 30)) {
                lines[4].style.borderLeft = '5px solid rgba(82, 199, 82, 0.7)'
                time[4].children[1].style.fontWeight = 'bold'
            } else {
                lines[4].style.borderLeft = '5px solid rgba(255, 0, 0, 0.7)'
            }
            break
        case 6:
            if (openClose() && ((hours === 11 && minutes >= 30) || (hours >= 12 && hours < 14))) {
                lines[5].style.borderLeft = '5px solid rgba(82, 199, 82, 0.7)'
                time[5].children[0].style.fontWeight = 'bold'
            } else if ((hours >= 18 && hours < 22) || (hours === 22 && minutes < 30)) {
                lines[5].style.borderLeft = '5px solid rgba(82, 199, 82, 0.7)'
                time[5].children[1].style.fontWeight = 'bold'
            } else {
                lines[5].style.borderLeft = '5px solid rgba(255, 0, 0, 0.7)'
            }
            break
    }
}
